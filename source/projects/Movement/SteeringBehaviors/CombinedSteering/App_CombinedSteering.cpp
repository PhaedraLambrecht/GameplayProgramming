...
void App_CombinedSteering::Start()
{
	...
	// Initialize agent & set everything correctly
	...
	// Initialize sober dude & set everything correctly
...
void App_CombinedSteering::Update(float deltaTime)
{
	...
	// Trim to the world size if m_TrimWorld = active
	if(m_TrimWorld)
	{
